...
def main():
    print("="*60)
    print("MODELO RANDOM FOREST - TOPBEL TRADICIONAL 50UN")
    print("="*60)
    ...
    # Filtrar apenas para o produto TOPBEL TRADICIONAL
    produto_data = df[df['product'] == 'TOPBEL TRADICIONAL 50UN'].copy()
    print(f"Total de registros para TOPBEL TRADICIONAL: {len(produto_data)}")
    ...
    # Salvar o modelo
    model_filename = '/workspaces/DemandAI/models/topbel_tradicional_rf_model.pkl'
    ...
    import json
    with open('/workspaces/DemandAI/models/topbel_tradicional_rf_model_info.json', 'w') as f:
    ...
    fig.suptitle('Modelo Random Forest - TOPBEL TRADICIONAL 50UN', fontsize=16)
    ...
    plt.tight_layout()
    plt.savefig('/workspaces/DemandAI/models/topbel_tradicional_rf_analysis.png', dpi=300, bbox_inches='tight')
    print("Gráficos salvos em: /workspaces/DemandAI/models/topbel_tradicional_rf_analysis.png")
    
    print("\n" + "="*60)
    print("MODELO TREINADO COM SUCESSO!")
    print("="*60)
    print(f"Modelo salvo: {model_filename}")
    print(f"Informações salvas: /workspaces/DemandAI/models/topbel_tradicional_rf_model_info.json")
    print(f"Visualizações salvas: /workspaces/DemandAI/models/topbel_tradicional_rf_analysis.png")
